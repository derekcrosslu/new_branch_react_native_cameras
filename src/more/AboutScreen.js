          ...
          <ScrollView>
            <View style={{padding: 20}}>
              <View style={{paddingBottom: 15}}>
                <Text style={{fontSize: 22, fontWeight: 'bold', color: 'black'}}>Virtual Service Company</Text>
              </View>
              <View>
            ...
            <View style={{padding: 20}}>
              <View style={{paddingBottom: 15}}>
                <Text style={{fontSize: 22, fontWeight: 'bold', color: 'black'}}>What makes us Different?</Text>
              </View>
              <View>
