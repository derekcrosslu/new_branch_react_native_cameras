...
export default class AddDeliveryScreen extends Component {
  constructor(props) {
    ...
    this.onSubmitcompanyname = this.onSubmitcompanyname.bind(this);
    this.onSubmitAbout = this.onSubmitAbout.bind(this);
    this.onSubmitEmail = this.onSubmitEmail.bind(this);
    this.onSubmitPassword = this.onSubmitPassword.bind(this);
    this.onAccessoryPress = this.onAccessoryPress.bind(this);

    this.companynameRef = this.updateRef.bind(this, 'companyname');
  ...
  onChangeText(text) {
    ['companyname', 'phonenum', 'secret', 'passcode']
      ...
      <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.flexCity}>
              <Text style={styles.headerText}>Add Delivery</Text>
            </View>
          ...
          <ScrollView keyboardShouldPersistTaps='handled'>
            ...
            <View style={{paddingTop: 20, paddingLeft: '10%', paddingBottom: 20}}> 
              ...
              <TouchableOpacity style={{flexDirection: 'row',padding: 5,  paddingLeft: 0, paddingLeft: 0, margin: 5, marginLeft: 0, marginLeft: 0}} onPress={() => this.setState({PermissionsTime: 'SpecifiedTime'})}>
                {SpecificTime}
                <View style={{paddingLeft: 10}}>
