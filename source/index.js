...
export default class RNAgoraExample extends Component {
    ...
    componentWillMount() {
        //初始化Agora
        const options = {
            appid: '5ce744437a4844f1860098316add9f68',
            channelProfile: 1,
            videoProfile: 40,
            clientRole: 1,
                    ...
                    <View>
                        ...
                        <View style={styles.bottomView}>
                            <OperateButton
                                ...
                                source={isCameraTorch ? require('../images/flash.png') : require('../images/no_flash.png')}
                            />
                            <OperateButton
                                onPress={this.handlerChangeVideo}
                                source={disableVideo ? require('../images/camera.png') : require('../images/no_camera.png')}
                            />
                        </View>
                        <View style={styles.bottomView}>
                            <OperateButton
